...
\section{technical skills \textsuperscript{(list is not exhaustive)}}
...
\cvitem{advanced}{\
  ...
  \textbf{Go}: goroutines, reflection, BLE, ORMs, socket.io  \newline{}
  % \textbf{rust}: - \newline{}
  \textbf{Networking}: DHCP, DNS, TCP, UDP ip, iw, nftables, ss, tc, tcpdump, Wireshark \newline{}
  \textbf{Operating systems}: Linux, bash, zsh, sed, ripgrep, vim \newline{}
  % \textbf{php}: idiorm \newline{}
...
\section{work experience (4 years, 1 month) \textsuperscript{(list is not exhaustive)}}
...
\section{books \textsuperscript{(list is not exhaustive)}}
...
\section{portfolio \textsuperscript{(list is not exhaustive)}}

\cventry{2017--2018}{curate-pkg}{aggregates all package managers under one tool}{}{}
{{\color{linkcolor} \url{https://github.com/andrei-pavel/curate-pkg}}}

\cventry{2015}{Make Monitor}{monitors compilation progress of make projects, written in C\#}{}{}
{{\color{linkcolor} \url{https://github.com/andrei-pavel/MakeMonitor}}}
...
\section{studies \textsuperscript{(list is not exhaustive)}}
