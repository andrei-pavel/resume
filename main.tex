...
\definecolor{myblue}{rgb}{0.32, 0.64, 1.0}
\definecolor{mygray}{rgb}{0.16, 0.32, 0.48}
\definecolor{linkcolor}{rgb}{0.32, 0.64, 1.0}
...
\email{andrei.pavel@mail.com}
\homepage{github.com/andrei-pavel}{https://github.com/andrei-pavel}
\homepageTwo{linkedin.com/in/pavelandrei/}{https://www.linkedin.com/in/pavelandrei/}
\photo[96pt][0.1pt]{pictures/portrait}
\begin{comment}
supporter of code correctness, performance, legibility\\
\end{comment}
\quote{I work best on Linux with C++, D, Dart, Flutter, Go, Rust\\
...
\cvitem{advanced}{{} \newline{}
  %  {\color{myblue}   \textbf{Android}: Java, Kotlin} \newline{}
  {\color{myblue} \textbf{C}}: C11, user-level, Arduino-dialect, OpenMP, MPI, pthreads \newline{}
  ...
  {\color{myblue} \textbf{Operating systems}}: Linux, systemd, sys-v-init, vim \newline{}
  {\color{myblue} \textbf{Scripting}}: bash, zsh, sed, ack, ripgrep \newline{}
  {\color{myblue} \textbf{Markup}}: bpml, css, dtd, json, html, latex, markdown, xml, xsd, xsl, yang \newline{}
  {\color{myblue} \textbf{Networking}}: DHCP, DNS, TCP, UDP ip, iw, netconf, netopeer, nftables, ss, tc, tcpdump, Wireshark \newline{}
...
\cvitem{intermediate, but excited about}{{} \newline{}
  %  {\color{myblue}   \textbf{C\#}: Windows Forms} \newline{}
...
\cventry{\
  \center{}
  \\\includegraphics[width=\hintscolumnwidth]{pictures/isc-transparent}
  October 2020 --- present\\({\difftoday{2020}{10}{01}})
}{\color{myblue} Software Engineer (formerly QA \& Support Engineer)}{\textbf{\textsc{Internet Systems Consortium}}}{Remote}{}{\
  \textbf{Kea: open-source DHCP server, C++}
}

\cventry{\
  \center{}
  \\\includegraphics[width=\hintscolumnwidth]{pictures/qualitance-transparent}
  May 2016 --- October 2020\\(4 years, \\5 months)
}{\color{myblue} Software Engineer (formerly Junior C++ Developer)}{\textbf{\textsc{Qualitance}}}{Romania}{}{\
  \textbf{Kea: open-source DHCP server, C++, enhancements}\\
  \textbf{Open-source contributions to CESNET, ISC, Sysrepo}
  \begin{itemize}
    \item {\color{linkcolor} \url{https://github.com/isc-projects/kea/pulls?q=author\%3AandreipavelQ}}
    \item {\color{linkcolor} \url{https://github.com/isc-projects/kea/pulls?q=author\%3Aandrei-pavel}}
    \item {\color{linkcolor} \url{https://github.com/sysrepo/sysrepo/pulls?q=author\%3Aandrei-pavel}}
    \item {\color{linkcolor} \url{https://github.com/CESNET/libyang/pulls?q=author\%3Aandrei-pavel}}
    \item {\color{linkcolor} \url{https://github.com/CESNET/Netopeer2/pulls?q=author\%3Aandrei-pavel}}
  \end{itemize}
  \begin{itemize}
    \item support for \textbf{Cassandra} operations with multiple data sources
    ...
    \item integration with Sysrepo data source, NETCONF protocol, YANG models
  \end{itemize}
...
\cventry{\
  \center{}
  \\\includegraphics[width=\hintscolumnwidth]{pictures/misys-transparent}
...
\cventry{\
  \center{}
  \\\includegraphics[width=\hintscolumnwidth]{pictures/intel-transparent}
